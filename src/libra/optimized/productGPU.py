...
class ProductGPU(AbstractDomainGPU):
    ...
    def miniPrintCondense(self,d_affine, if_activation,d_active_pattern, d_l1_lb,d_l1_ub,domains,d_relu_dp = None,d_symb = None):
        dpG = DeepPolyGPU()
        smbG = SymbolicGPU()
    ...
    def noPrintCondense(self,d_affine, if_activation,d_active_pattern, d_l1_lb,d_l1_ub,domains,d_relu_dp = None,d_symb = None):
        dpG = DeepPolyGPU()
        smbG = SymbolicGPU()
        d_lbsL = cp.zeros((len(domains), len(d_affine[0])))
        d_ubsL = cp.zeros((len(domains), len(d_affine[0])))
    ...
    def network_condense_GPU(self,nodes, initial,domains):
        ...
        self.miniPrintCondense(d_affine, if_activation,d_active_pattern, d_l1_lb,d_l1_ub,domains,d_relu_dp = d_relu_dp,d_symb = d_symb)
        #self.noPrintCondense(d_affine, if_activation,d_active_pattern, d_l1_lb,d_l1_ub,domains,d_relu_dp = d_relu_dp,d_symb = d_symb)
